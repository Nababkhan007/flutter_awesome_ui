//A circular loading indicator made up of colored dots. The current dot circles around the dot clockwise.
import 'dart:math' as math;
import 'package:flutter/material.dart';

class CustomDottedProgressIndicator extends StatefulWidget {
  const CustomDottedProgressIndicator({
    Key? key,
  ...
  @override
  State<CustomDottedProgressIndicator> createState() =>
      _CustomDottedProgressIndicatorState();
}

class _CustomDottedProgressIndicatorState
    extends State<CustomDottedProgressIndicator>
...
//  Calculates the offset each dot based on the total number of dots
class Circle {
  int totalNumOfDots;
  double radius;
